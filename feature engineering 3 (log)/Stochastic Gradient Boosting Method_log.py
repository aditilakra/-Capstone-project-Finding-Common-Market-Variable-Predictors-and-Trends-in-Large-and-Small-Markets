...
#GBM for rental predictions on unweighted rents
...
gbm5 = GradientBoostingRegressor(alpha=0.9, criterion='friedman_mse', init=None,
             ...
             presort='auto', random_state=None, subsample=0.33, verbose=0,
             warm_start=False)
gbm5.fit(ind.new, dep.new)

#Cross-validated Train errors
pred=gbm5.predict(ind.new)
...
#Cross-validated Train errors
pred_test=gbm5.predict(ind.new)
rent_predictions = pred_test.applymap(exp)
