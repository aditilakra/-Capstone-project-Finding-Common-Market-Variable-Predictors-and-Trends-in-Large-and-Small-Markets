...
strat_train_set_wo_MGR1 = pandas.read_csv('/Users/aditilakra/Desktop/capstone/feature engineering 6/strat_train_set_wo_MGR1.csv')
strat_test_set_wo_MGR1 = pandas.read_csv('/Users/aditilakra/Desktop/capstone/feature engineering 6/strat_test_set_wo_MGR1.csv')
...
temp1 = numpy.power(temp, 10) - 0.0001
...
temp_test1 = numpy.power(temp_test,10) - 0.0001
