...
strat_train_set_wo_MGR1 = pandas.read_csv('D:/Desktop/Capstone_Greystone/Data aggregation/Final Datasets/strat_train_set_wo_MGR1.csv')
strat_test_set_wo_MGR1 = pandas.read_csv('D:/Desktop/Capstone_Greystone/Data aggregation/Final Datasets/strat_test_set_wo_MGR1.csv')
...
log=lambda x: math.log10(x+0.0001)
ind=ind.applymap(log)

dep =(strat_train_set_wo_MGR1['rent_final']/strat_train_set_wo_MGR1['SE_T104_001']).copy()
dep=numpy.log10(dep+0.0001)

grid_search.fit(ind, dep)
grid_search.best_params_
grid_search.best_estimator_

gbm9 = GradientBoostingRegressor(alpha=0.9, criterion='friedman_mse', init=None,
...
temp = gbm9.predict(ind)
temp1 = numpy.power(10, temp) - 0.0001
...
temp_test = gbm9.predict(ind_test)
temp_test1 = numpy.power(10, temp_test) - 0.0001
