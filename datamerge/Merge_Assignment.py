#Merge Apartments.com Data to DSCompsZip2016
...
#dscompszip = pandas.read_csv('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Data aggregation/eugene_dscompszip.csv')
#dscompszip = pandas.read_csv('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Data aggregation/columbia_dscompszip.csv')
#dscompszip = pandas.read_csv('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Data aggregation/dayton_dscompszip.csv')
#dscompszip = pandas.read_csv('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Data aggregation/chattanooga_dscompszip.csv')
#dscompszip = pandas.read_csv('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Data aggregation/austin_dscompszip.csv')
#dscompszip = pandas.read_csv('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Data aggregation/chicago_dscompszip.csv')
dscompszip = pandas.read_csv('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Data aggregation/newyork_dscompszip.csv')

dscompszip.drop('Unnamed: 0', axis=1, inplace=True)

#Read Aparqtments.com Data
#apt = pandas.read_excel('/Users/aditilakra/Desktop/capstone/Capstone_combined data/EUGENE.xlsx')
#apt = pandas.read_excel('/Users/aditilakra/Desktop/capstone/Capstone_combined data/columbia.xlsx')
#apt = pandas.read_excel('/Users/aditilakra/Desktop/capstone/Capstone_combined data/dayton.xlsx')
#apt = pandas.read_excel('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Chattanooga.xlsx')
#apt = pandas.read_excel('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Austin.xlsx')
#apt = pandas.read_excel('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Chicago.xlsx')
apt = pandas.read_excel('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Newyork.xlsx')

#Check for duplicates - Property Name, Address

#pandas.value_counts(apt['Property Name']).to_frame().reset_index()
#pandas.value_counts(apt['Address']).to_frame().reset_index()
#pandas.value_counts(apt['bedroom']).to_frame().reset_index()
#'Monthly Fees'	'One Time Fees'	'Pet Policy'	'Parking'	'Gym'	'Kitchen'	'Amenities'	'Features'	'Living Space'	'Lease Info'	'Services'	'Indoor Info'	'Outdoor Info'
...
zip2016 = pandas.read_csv('/Users/aditilakra/Desktop/capstone/tej_files/R11617789_SL860_2016.csv')
...
#Merge dscompszip and aptv1 - only 14 matches on inner join, need fuzzy match
#fuzzy match has given 20 matches
import difflib
#dscompszipapt = pandas.merge(dscompszip, aptv1, how='inner', left_on=['requeststreet'],right_on=['Address'])
#dscompszip[(dscompszip['requeststreet']=='721 Throne Dr')]
...
#aptv4 = aptv3[aptv3['Address'].isin(unique_add)]
...
#dscompszipapt.to_csv('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Data aggregation/eugene_dscompszipapt.csv')

#Write aggregated file and miss values to disk - Columbia Deep Search + Deep Comps + Zip 2016 + Aptmts.com
#dscompszipapt.to_csv('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Data aggregation/columbia_dscompszipapt.csv')

#Write aggregated file and miss values to disk - Columbia Deep Search + Deep Comps + Zip 2016 + Aptmts.com
#dscompszipapt.to_csv('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Data aggregation/dayton_dscompszipapt.csv')

#Write aggregated file and miss values to disk - Chattanooga Deep Search + Deep Comps + Zip 2016 + Aptmts.com
#dscompszipapt.to_csv('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Data aggregation/chattanooga_dscompszipapt.csv')

#Write aggregated file and miss values to disk - austin Deep Search + Deep Comps + Zip 2016 + Aptmts.com
#dscompszipapt.to_csv('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Data aggregation/austin_dscompszipapt.csv')

#Write aggregated file and miss values to disk - chicago Deep Search + Deep Comps + Zip 2016 + Aptmts.com
#dscompszipapt.to_csv('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Data aggregation/chicago_dscompszipapt.csv')

#Write aggregated file and miss values to disk - new york Deep Search + Deep Comps + Zip 2016 + Aptmts.com
dscompszipapt.to_csv('/Users/aditilakra/Desktop/capstone/Capstone_combined data/Data aggregation/newyork_dscompszipapt.csv')
